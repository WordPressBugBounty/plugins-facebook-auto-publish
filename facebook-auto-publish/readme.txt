...
= WP2Social Auto Publish 2.4.13 =
* Fixed a security issue related to stored XSS in the selected Facebook pages settings.
* Improved input sanitization and output escaping in the Facebook page selection settings.
* Improved AJAX request capability and nonce validation.
...
= WP2Social Auto Publish 2.4.11 =
* Fixed scheduled auto-publish issue
* Improved post status handling
* Minor bug fixes and code improvements

= WP2Social Auto Publish 2.4.10 =
* Added vulnerability fix reported by WP Plugin Review Team.

= WP2Social Auto Publish 2.4.9 =
* Fixed: Minor constant name typo causing an error in the About page

= WP2Social Auto Publish 2.4.8 =
* SMAPSolutions package expiry alert added
* Minor bug fixes and code tweaks
* Fixed a security issue identified through responsible disclosure.
